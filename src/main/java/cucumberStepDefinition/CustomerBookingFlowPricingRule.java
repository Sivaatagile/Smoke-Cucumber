...
////*************************     PREMIUM PRICINGRULE DATE
	...
	public void theUserGatheringThePricingrulePremiumDateFromPropertyfile() {
		PremiumDATE = MergePricingruleDate(getProperty("TO_Month_Premium_PricingRule"),
	...
	public void theUserGatheringThePricingruleNotAvailableDateFromPropertyfile() {
		NotaAvailableDATE = MergePricingruleDate(getProperty("TO_Month_PricingRule_NotAvailable"),
				getProperty("TO_Date_PricingRule_NotAvailable"), getProperty("TO_Year_PricingRule_NotAvailable"));
	}
